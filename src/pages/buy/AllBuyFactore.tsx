...
import { useUpdateBuy, useUpdateBuyReturn } from "../../hooks/mutation";
...
function AllBuyFactore() {
  ...
  return (
    <section>
      <FactoreDataTable type={"buy"} data={finalData} />
    </section>
  );
}

export default AllBuyFactore;

export const FactoreDataTable = ({ data, type }) => {
  return (
