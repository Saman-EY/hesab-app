...
const validationSchema = Yup.object({
    ...
    department: Yup.string().required("الزامی است"),
});
            ...
            <section className="bg-gray-100 shadow-lg mt-20 p-5 w-full max-w-100 rounded-lg flex flex-col justify-center items-center mx-auto gap-5">
                ...
                <div className="w-full flex flex-col">
                    ...
                    >
                        ...
                        <option value={"department1"}>شرکت 1</option>
                        <option value={"department2"}>شرکت 2</option>
                        <option value={"department3"}>شرکت 3</option>
                    </select>
