...
export const useCreateUser = () => {
    ...
    return useMutation({
        mutationFn: async (body: { username: string; password: string; role: string }) => {
            const response = await publicApi.post("/user/login", body);
...
export const useCreateCat = () => {
    return useMutation({
        mutationFn: async (body: any) => {
            const response = await api.post("/categories/category", body);
            return response.data;
        },
        onSuccess: () => {
            toast.success("ثبت شد");
...
export const useCreateSubCat = () => {
    return useMutation({
        mutationFn: async (body: any) => {
            const response = await api.post("/categories/subcategory", body);
            return response.data;
        },
        onSuccess: () => {
            toast.success("ثبت شد");
...
export const useDeleteSubCat = () => {
    return useMutation({
        mutationFn: async (id: string) => {
            const response = await api.delete(`/categories/subcategory/${id}`);
            return response.data;
        },
        onSuccess: () => {
            toast.success("حذف شد");
